...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="{{route('add.user')}}">Add PhoneUser</a>
                                </nav>
                            </div>
        ...
        <script src="{{asset('adminasset')}}/assets//chart-area-demo.js"></script>
        <script src="{{asset('adminasset')}}/assets//chart-bar-demo.js"></script>
